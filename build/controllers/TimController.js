...
var TimController = /** @class */ (function () {
    ...
    TimController.prototype.store = function (req, res) {
        Tim_1.Tim.create(req.body.tim).then(function (data) { return res.json(data); });
    };
    TimController.prototype.update = function (req, res) {
        Tim_1.Tim.findOneAndUpdate({ _id: req.params._id }, { $set: req.body.tim }, { new: true }).then(function (data) { return res.json(data); });
    };
